...
def resolve_plot_path(case_folder: Path, test_id: str) -> Path:
    candidates = (
        case_folder / "Original" / f"plot_{test_id}_original.png",
        case_folder / "Ori" / f"plot_{test_id}_original.png",
    )
    ...
    for case in cases:
        ...
        with transition_path.open("r", encoding="utf-8-sig", newline="") as handle:
            for row in csv.DictReader(handle):
                ...
                plot_path = resolve_plot_path(case_folder, test_id)
