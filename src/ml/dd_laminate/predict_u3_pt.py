...
def _record(csv_path: Path, theta1: float, theta2: float, case: str, u3_bucket: str | int) -> U3Record:
...
def predict_u3_pt_classical(
    ...
    record, _seq, _meta, x_classical, max_force, max_disp = _features(csv_path, theta1, theta2, case, u3_bucket)
...
def predict_u3_pt_deep(
    ...
    record, seq, meta, _x_classical, max_force, max_disp = _features(csv_path, theta1, theta2, case, u3_bucket)
