...
def train_forecast(
    ...
    lines = [
        ...
        "## Best Scalar Model",
        f"- `{best_name}`",
        f"- Pt MAE: {metrics_by_model[best_name]['cv_pt_mae_mean']:.2f} +/- {metrics_by_model[best_name]['cv_pt_mae_std']:.2f} lbf",
        ...
        "",
        "## GointMLP Forecast",
        f"- Pt MAE: {goint_metrics['cv_pt_mae_mean']:.2f} +/- {goint_metrics['cv_pt_mae_std']:.2f} lbf",
