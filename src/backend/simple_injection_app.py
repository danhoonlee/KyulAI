...
VALIDATION_SAMPLE_FILES = {
    "G01_P01_Sprue_Pressure.csv": (
        SIMPLE_INJECTION_DATA_DIR / "Training/Sprue_Pressure/G01/P01/G01_P01_Sprue_Pressure.csv"
    ),
    "G01_P01_Filling_Pressure.csv": (
        SIMPLE_INJECTION_DATA_DIR / "Training/Filling_Pressure/G01/P01/G01_P01_Filling_Pressure.csv"
    ),
}
