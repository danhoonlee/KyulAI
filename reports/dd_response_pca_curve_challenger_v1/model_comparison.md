...
- Output artifacts: `models/dd_laminate_response_pca_curve_challenger_v1`
...
| pca_curve_mlp | trained | 0.9200 | 0.9150 | 571.44 | 877.45 | 0.07869 | 2580.10 | 5.90 | 0.0292 | 120218 | 0.491 |
...
`pca_curve_mlp` is the best DL challenger in this run, but it does not clearly beat `response_goint_physics_nn_v2` across the main response metrics.
